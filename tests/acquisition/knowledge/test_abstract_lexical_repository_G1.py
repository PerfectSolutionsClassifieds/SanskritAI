...
class TestRepository(AbstractLexicalRepository):
    """
    Minimal in-memory repository used to exercise the abstract repository
    contract and its concrete helper methods.
    """
...
def make_record(
    ...
    The test intentionally discovers the model contract through the
    repository-facing ``headword`` field.
    """
