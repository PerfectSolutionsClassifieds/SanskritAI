...
def make_lemma(
    ...
    """
    Creates an immutable CanonicalLemma.
    """
...
def make_context(
    ...
    """
    Creates an immutable CanonicalContext.

    The current model derives its identifier from its
    canonical context fields. Using ``corpus`` as the
    minimal identity-bearing field gives us the requested
...
def make_source(
    ...
    """
    Creates an immutable CanonicalSource.
    """
...
def make_sense(
    ...
    """
    Creates an immutable CanonicalDictionarySense.
    """
...
def make_entry(
    ...
    """
    Creates an immutable CanonicalDictionaryEntry.

    Senses are supplied directly through the constructor.
    """
...
def make_lexicon(
    *entries: CanonicalDictionaryEntry,
    ...
    """
    Creates an immutable CanonicalLexicon.

    Entries are supplied as a headword -> entry mapping.
    """
