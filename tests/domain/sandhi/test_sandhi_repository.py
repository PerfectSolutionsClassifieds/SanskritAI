...
class ConcreteSandhiRule(SandhiRule):
    ...
    def apply(self, context) -> tuple[str, ...]:
        return ()


class InMemorySandhiRepository(SandhiRepository):
    ...
    def search(
        ...
        return SandhiRuleSet(rules=matches)

    def all(self) -> SandhiRuleSet:
        return SandhiRuleSet(rules=self._rules)
