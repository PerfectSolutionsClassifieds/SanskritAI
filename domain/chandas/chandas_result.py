...
Defines the immutable outcome produced by every Chandas
analysis.
...
class ChandasResult(
    ...
    """
    Immutable result produced by Chandas analysis.
    """

    context: ChandasContext

    analyses: ChandasAnalysisCollection = field(
        default_factory=ChandasAnalysisCollection
    )
    ...
    diagnostics: tuple[ChandasDiagnostic, ...] = field(default_factory=tuple)
    ...
    @property
    def first_analysis(self) -> ChandasAnalysis | None:
        return self.analyses.first

    @property
    def result(self) -> ChandasAnalysisCollection:
    ...
    @property
    def first_diagnostic(self) -> ChandasDiagnostic | None:
    ...
    @property
    def best_analysis(self) -> ChandasAnalysis | None:
