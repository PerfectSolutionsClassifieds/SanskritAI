...
class DictionarySenseValidator(
    ...
    def validate(
        ...
        # -----------------------------------------------------
        #
        # Validate the actual backing field rather than relying
        # exclusively on the public metadata property.
        #
        # The test suite intentionally allows:
        #
        #     sense._metadata = None
        #
        # Therefore, the backing state is the authoritative
        # indication that metadata is genuinely absent.
        # -----------------------------------------------------
