...
class DictionarySenseValidator(
    ...
    def validate(
        ...
        # -----------------------------------------------------
        #
        # DictionarySense exposes metadata through its public
        # interface, but the tests and domain model permit the
        # backing _metadata field to be explicitly set to None.
        #
        # Validate the actual backing state so that a genuinely
        # missing metadata object cannot be hidden by a property
        # default or fallback.
        # -----------------------------------------------------
