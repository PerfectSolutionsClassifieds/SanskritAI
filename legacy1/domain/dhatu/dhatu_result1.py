...
DhatuResult is the central value object of the Dhatu Kernel.
...
class DhatuResult(
    ...
    """
    Immutable result produced by Dhatu resolution.
    """
    ...
    diagnostics: tuple[DhatuDiagnostic, ...] = field(default_factory=tuple)
    ...
    @property
    def first_diagnostic(self) -> DhatuDiagnostic | None:
