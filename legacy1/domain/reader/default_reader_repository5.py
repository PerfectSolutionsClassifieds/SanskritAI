...
class DefaultReaderRepository(
    ...
    def _verse_text(
        ...
        """
        Reconstruct the canonical display text of a Verse
        from its Paragraph -> Line -> Token hierarchy.

        Token.text is used rather than normalized_text because
        the reader should display the original canonical surface
        form.
        """
        ...
        for paragraph in verse.paragraphs:
            ...
            for line in paragraph.lines:
                ...
                for token in line.tokens:
                    ...
                    if (
                        parts
                        and token.metadata.has_leading_whitespace
                    ):
                        parts.append(" ")
                ...
                if (
                    parts
                    and line.tokens
                    and line.tokens[-1].metadata.has_trailing_whitespace
                ):
                    parts.append(" ")
