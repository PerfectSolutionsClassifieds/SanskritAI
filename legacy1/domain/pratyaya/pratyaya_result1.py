...
PratyayaResult is the central value object of the Pratyaya
Kernel.
...
class PratyayaResult(
    ...
    """
    Immutable result produced by Pratyaya resolution.
    """
    ...
    diagnostics: tuple[PratyayaDiagnostic, ...] = field(default_factory=tuple)
    ...
    @property
    def first_diagnostic(self) -> PratyayaDiagnostic | None:
