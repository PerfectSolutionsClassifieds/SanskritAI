...
The ``by_*()`` operations return CanonicalContext objects because
they represent structural navigation over the textual corpus.
...
class ContextIndex:
    ...
    def add(
        ...
        if purana:
            bucket = self._purana_index.setdefault(
                purana,
                [],
            )
        ...
        if chapter_identifier:
            bucket = self._chapter_index.setdefault(
                chapter_identifier,
                [],
            )
        ...
        if sloka_identifier:
            bucket = self._sloka_index.setdefault(
                sloka_identifier,
                [],
            )
    ...
    def _chapter_identifier(
        ...
        parts = [
            cls._normalise(context.corpus),
            cls._normalise(context.work),
            cls._normalise(context.chapter),
        ]
    ...
    def summary(
        ...
        return {
            ...
            "puranas": self.purana_count,
            "chapters": self.chapter_count,
            "slokas": self.sloka_count,
        }
