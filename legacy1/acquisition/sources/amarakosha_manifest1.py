...
def create_amarakosha_manifest() -> AcquisitionManifest:
    ...
    The current canonical acquisition input is:

        /content/SanskritAI/amarakosha.txt

    This manifest intentionally represents LOCAL acquisition.

    It does not claim that the Sanskrit Documents PDFs are the
    parent source of the TXT artifact.
    """
