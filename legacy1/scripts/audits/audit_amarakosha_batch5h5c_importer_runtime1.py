...
from SanskritAI.lexical.sources.lexical_source import LexicalSource
...
print(
    "Identifier :",
    synset.identifier,
    "PASS" if synset.identifier == "synset:hari" else "FAIL",
)

print(
    "Child count :",
    synset.child_count,
    "PASS" if synset.child_count == 1 else "FAIL",
)
...
print(
    "Lexeme identity :",
    child is lexeme,
    "PASS" if child is lexeme else "FAIL",
)
...
print(
    "Identifier :",
    varga.identifier,
    "PASS" if varga.identifier == "varga:hari" else "FAIL",
)
...
print(
    ...
    "PASS" if empty_synset.child_count == 0 else "FAIL",
)
