...
Defines the immutable registration of an EventHandler.

A subscription specifies:

- which EventType is accepted
- which handler is invoked
- priority
- enabled state

Runtime dispatch belongs to EventDispatcher.
...
class EventSubscription(
    ...
    def supports(
        ...
        """
        Determines whether the subscription accepts
        the supplied event.
        """
        return (
            self.enabled
