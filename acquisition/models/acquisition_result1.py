...
A result starts in a neutral/unsuccessful state and becomes
successful only when the acquisition operation explicitly
...
class AcquisitionResult:
    ...
    def mark_success(
        ...
        """
        Marks the acquisition as successful.

        Success is explicit rather than implicit.
        """
