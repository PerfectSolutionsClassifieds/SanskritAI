...
print(
    "LexicalSource construction : PASS"
)

print(
    "LexicalRepository construction : PASS"
)

print(
    "Lexeme construction : PASS"
)
...
print(
    "Lexeme constructed through LexemeMetadata : PASS",
)
