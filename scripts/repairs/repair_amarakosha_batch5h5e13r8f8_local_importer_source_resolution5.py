...
Important
---------
The canonical resolver intentionally uses:
...
The validator therefore checks the semantic AST structure of the
getattr() call rather than requiring one particular syntax shape.
"""
...
def executable_body(
    ...
    This prevents documentation such as:

        manifest.source.local_path

    from being mistaken for executable access.
    """
