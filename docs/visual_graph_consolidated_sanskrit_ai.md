        ...
        📂 reader/
          ...
          📄 test_reader_navigator.py
              ...
              🏗️ Classes:
                ...
                • class FakeRepository:
                  ...
                  - next_word(self, word_id)
                  - previous_word(self, word_id)
                • class RecordingPositionFactory:
          ...
          📄 test_reader_position_factory.py
              ⚙️ Functions:
                ...
                • test_chapter_rejects_empty_purana_id()
                • test_chapter_rejects_empty_chapter_id()
                • test_chapter_rejects_whitespace_purana_id()
                • test_chapter_rejects_whitespace_chapter_id()
                ...
                • test_word_rejects_none_identifiers()
          ...
          📄 test_reader_selection_context.py
              ⚙️ Functions:
                ...
                • test_reader_selection_context_exposes_position_identifiers()
                • test_reader_selection_context_exposes_position_state()
                • test_reader_selection_context_has_hierarchy_flags()
                • test_reader_selection_context_to_position_returns_canonical_position()
