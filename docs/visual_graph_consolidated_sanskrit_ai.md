        ...
        📂 knowledge/
          ...
          📄 test_canonical_knowledge_repository.py
              ⚙️ Functions:
                ...
                • test_all_canonical_repositories_are_constructed()
                • test_canonical_services_are_constructed()
                • test_registry_uses_same_repository_instances()
                • test_registry_uses_same_service_instances()
                • test_lexical_service_uses_canonical_repository()
                • test_morphological_service_uses_canonical_repository()
                • test_sandhi_service_uses_canonical_repository()
                • test_samasa_service_uses_canonical_repository()
                • test_semantic_service_uses_canonical_repository()
                • test_lexical_alias_returns_lexical_service()
                • test_dhatu_alias_returns_dhatu_service()
                • test_morphology_alias_returns_morphological_service()
                • test_sandhi_alias_returns_sandhi_service()
                • test_samasa_alias_returns_samasa_service()
                • test_semantic_alias_returns_semantic_service()
                • test_lexical_property_delegates_to_registry()
                • test_dhatu_property_delegates_to_registry()
                • test_morphology_property_delegates_to_registry()
                • test_sandhi_property_delegates_to_registry()
                • test_samasa_property_delegates_to_registry()
                • test_semantic_property_delegates_to_registry()
                • test_repository_count_delegates_to_registry()
                • test_service_count_delegates_to_registry()
                • test_component_count_delegates_to_registry()
                • test_len_returns_component_count()
                • test_registry_has_six_repositories()
                • test_registry_has_six_services()
                • test_registry_has_twelve_components()
          ...
          📄 test_knowledge_service_registry.py
              ⚙️ Functions:
                • make_components()
                • make_registry()
                • test_registry_can_be_constructed()
                • test_registry_preserves_repository_references()
                • test_registry_preserves_service_references()
                • test_repository_count_is_six()
                • test_service_count_is_six()
                • test_component_count_is_twelve()
                • test_len_returns_total_component_count()
                • test_lexical_alias_points_to_lexical_service()
                • test_dhatu_alias_points_to_dhatu_service()
                • test_morphology_alias_points_to_morphological_service()
                • test_sandhi_alias_points_to_sandhi_service()
                • test_samasa_alias_points_to_samasa_service()
                • test_semantic_alias_points_to_semantic_service()
                • test_registry_is_frozen()
                • test_registry_contains_six_repository_fields()
                • test_registry_contains_six_service_fields()
                • test_registry_exposes_all_canonical_services()
                • test_registry_component_count_equals_repository_plus_services()
          📂 builders/
            📄 test_canonical_index_builder.py
                ⚙️ Functions:
                  • make_lemma(text)
                  • make_context(identifier)
                  • make_source(source_id)
                  • make_sense(context, source, sense_id, entry_headword, definition)
                  • make_entry(headword, lemma, senses)
                  • make_lexicon(*entries)
                  • make_builder()
                  • test_builder_can_be_constructed()
                  • test_builder_contains_all_four_indexes()
                  • test_build_empty_lexicon_collection_clears_indexes()
                  • test_build_indexes_dictionary_entry_headword()
                  • test_build_indexes_multiple_headwords()
                  • test_build_indexes_entry_lemma()
                  • test_entry_without_lemma_is_not_added_to_lemma_index()
                  • test_build_indexes_sense_context()
                  • test_sense_without_context_is_not_added_to_context_index()
                  • test_build_indexes_sense_source()
                  • test_sense_without_source_is_not_added_to_source_index()
                  • test_multiple_senses_are_indexed()
                  • test_build_processes_multiple_lexicons()
                  • test_build_replaces_previous_index_contents()
                  • test_repeated_build_is_deterministic()
                  • test_clear_removes_all_index_data()
                  • test_summary_reports_all_indexes()
                  • test_string_representation_contains_summary()
            📄 test_canonical_knowledge_repository_builder.py
                ⚙️ Functions:
                  • make_lexicon(identifier, name, version)
                  • make_repository()
                  • make_index_builder()
                  • make_builder(repository, index_builder)
                  • test_builder_can_be_constructed()
                  • test_builder_retains_repository()
                  • test_builder_retains_index_builder()
                  • test_build_returns_repository()
                  • test_build_populates_lexical_repository()
                  • test_build_synchronizes_indexes()
                  • test_build_registers_all_lexicons()
                  • test_build_clears_previous_repository_state()
                  • test_build_synchronizes_indexes_after_rebuild()
                  • test_add_lexicon_registers_lexicon()
                  • test_add_lexicon_resynchronizes_indexes()
                  • test_add_multiple_lexicons_is_incremental()
                  • test_clear_clears_lexical_repository()
                  • test_clear_clears_indexes()
                  • test_summary_delegates_to_repository()
                  • test_string_representation_contains_builder_name()
          📂 connectors/
            📄 test_abstract_lexical_connector.py
                ⚙️ Functions:
                  • test_connector_can_be_instantiated_through_concrete_subclass()
                  • test_abstract_connector_cannot_be_instantiated_directly()
                  • test_validate_returns_transformed_object_unchanged()
                  • test_summary_returns_connector_metadata()
                  • test_string_representation()
                  • test_discover_stage()
                  • test_acquire_stage(tmp_path)
                  • test_parse_stage(tmp_path)
                  • test_transform_stage()
                  • test_publish_stage()
                  • test_execute_runs_complete_connector_lifecycle(tmp_path)
                  • test_execute_runs_stages_in_canonical_order(tmp_path)
                🏗️ Classes:
                  • class ConcreteLexicalConnector:
                    - __init__(self)
                    - discover(self)
                    - acquire(self, destination)
                    - parse(self, source)
          ...
          📂 indexes/
            📄 test_context_index.py
                ⚙️ Functions:
                  • make_context(identifier)
                  • make_sense(name)
                  • test_index_starts_empty()
                  • test_add_registers_sense_under_context_identifier()
                  • test_multiple_senses_share_same_context_bucket()
                  • test_different_contexts_create_different_buckets()
                  • test_lookup_unknown_context_returns_empty_tuple()
                  • test_clear_removes_all_contexts()
                  • test_summary_reports_context_count()
                  • test_contains_checks_context_identifier()
                  • test_iteration_returns_sorted_context_identifiers()
                  • test_string_representation_contains_context_count()
            📄 test_headword_index.py
                ⚙️ Functions:
                  • make_entry(headword)
                  • test_index_starts_empty()
                  • test_add_indexes_entry_by_headword()
                  • test_add_strips_headword_before_indexing()
                  • test_add_ignores_empty_headword()
                  • test_add_preserves_first_entry_for_duplicate_headword()
                  • test_build_replaces_existing_index()
                  • test_clear_removes_all_entries()
                  • test_lookup_returns_none_for_unknown_headword()
                  • test_prefix_search_returns_matching_entries()
                  • test_prefix_search_returns_sorted_results()
                  • test_prefix_search_strips_prefix()
                  • test_empty_prefix_search_returns_empty_tuple()
                  • test_all_entries_are_sorted_by_headword()
                  • test_headwords_are_sorted()
                  • test_summary_reports_indexed_entries_and_headwords()
                  • test_iteration_returns_sorted_entries()
                  • test_contains_uses_exact_headword()
                  • test_string_representation_contains_count()
            📄 test_knowledge_index.py
                ⚙️ Functions:
                  • make_knowledge_index()
                  • make_entry(headword)
                  • make_lemma(lemma_id, text)
                  • make_context(identifier)
                  • make_source(source_id)
                  • make_sense(name)
                  • test_knowledge_index_contains_all_component_indexes()
                  • test_summary_reports_all_index_counts()
                  • test_summary_reports_zero_for_empty_indexes()
                  • test_clear_propagates_to_all_indexes()
                  • test_clear_does_not_replace_component_indexes()
                  • test_string_representation_contains_summary()
                  • test_indexes_can_be_populated_independently()
                  • test_knowledge_index_is_slot_based()
                  • test_component_indexes_are_independent()
            📄 test_lemma_index.py
                ⚙️ Functions:
                  • make_lemma(lemma_id, text)
                  • test_index_starts_empty()
                  • test_add_indexes_by_id_and_text()
                  • test_add_preserves_first_lemma_for_duplicate_id()
                  • test_add_preserves_first_lemma_for_duplicate_text()
                  • test_build_replaces_existing_index()
                  • test_clear_removes_both_indexes()
                  • test_lookup_returns_none_for_unknown_id()
                  • test_lookup_text_returns_none_for_unknown_text()
                  • test_all_returns_lemmas_sorted_by_text()
                  • test_lemma_ids_are_sorted()
                  • test_lemma_texts_are_sorted()
                  • test_summary_reports_counts()
                  • test_iteration_returns_all_sorted_lemmas()
                  • test_contains_checks_lemma_id()
                  • test_string_representation_contains_count()
            📄 test_source_index.py
                ⚙️ Functions:
                  ...
                  • make_sense(name)
                  • test_index_starts_empty()
                  • test_add_registers_sense_under_source_id()
                  • test_multiple_senses_share_same_source_bucket()
                  • test_different_sources_create_different_buckets()
                  • test_lookup_unknown_source_returns_empty_tuple()
                  • test_clear_removes_all_sources()
                  • test_summary_reports_source_count()
          ...
          📂 lookup/
            📄 test_lexical_lookup_engine.py
                ⚙️ Functions:
                  ...
                  • make_sense(name)
                  • make_engine()
                  • test_engine_can_be_constructed()
                  • test_engine_contains_all_four_indexes()
                  • test_lookup_headword_returns_matching_entry()
                  • test_lookup_headword_returns_none_for_unknown_headword()
                  • test_lookup_headword_delegates_whitespace_normalization()
                  • test_prefix_search_returns_matching_entries()
                  • test_prefix_search_returns_empty_tuple_for_unknown_prefix()
                  • test_lookup_lemma_returns_matching_lemma()
                  • test_lookup_lemma_returns_none_for_unknown_id()
                  • test_lookup_lemma_text_returns_matching_lemma()
                  • test_lookup_lemma_text_returns_none_for_unknown_text()
                  • test_lookup_lemma_text_delegates_whitespace_normalization()
                  • test_lookup_context_returns_senses_for_context()
                  • test_lookup_context_returns_empty_tuple_for_unknown_context()
                  • test_lookup_context_delegates_whitespace_normalization()
                  • test_lookup_source_returns_senses_for_source()
                  • test_lookup_source_returns_empty_tuple_for_unknown_source()
                  • test_lookup_source_delegates_whitespace_normalization()
                  • test_search_returns_headword_lemma_and_prefix_matches()
                  • test_search_returns_empty_results_for_unknown_query()
                  • test_search_strips_query_through_index_apis()
                  • test_engine_can_coordinate_multiple_indexes()
                  • test_summary_reports_all_index_counts()
                  • test_empty_engine_summary_reports_zero_counts()
                  • test_string_representation_contains_engine_name()
                  • test_string_representation_mentions_index_domains()
          📂 models/
            📄 test_canonical_context.py
                ⚙️ Functions:
                  • test_context_creation()
                  • test_context_identifier()
                  • test_context_identifier_omits_none_values()
            ...
            📄 test_canonical_dictionary_entry.py
                ⚙️ Functions:
                  ...
                  • test_dictionary_entry_creation()
                  • test_sense_count()
                  • test_display_name()
                  • test_has_transliteration()
                  • test_has_transliteration_false()
                  • test_has_multiple_senses()
                  • test_has_multiple_senses_false()
                  • test_primary_sense()
                  • test_primary_sense_empty()
                  • test_summary()
                  • test_iteration()
                  • test_string()
                  • test_entry_immutability()
            📄 test_canonical_dictionary_sense.py
                ⚙️ Functions:
                  • test_dictionary_sense_creation()
                  • test_has_context()
                  • test_has_context_false()
                  • test_has_source()
                  • test_has_grammar()
                  • test_has_grammar_false()
                  • test_identifier()
                  • test_summary()
                  • test_sense_string_with_context()
                  • test_sense_string_without_context()
                  • test_sense_immutability()
            📄 test_canonical_etymology.py
                ⚙️ Functions:
                  • test_etymology_creation()
                  • test_has_dhatu()
                  • test_has_dhatu_false()
                  • test_has_pratyaya()
                  • test_reference_count()
                  • test_etymology_summary()
                  • test_etymology_string()
                  • test_etymology_immutability()
            📄 test_canonical_example.py
                ⚙️ Functions:
                  • test_example_creation()
                  • test_has_translation()
                  • test_has_translation_false()
                  • test_has_context()
                  • test_reference_count()
                  • test_example_summary()
                  • test_example_string()
                  • test_example_immutability()
            📄 test_canonical_lemma.py
                ⚙️ Functions:
                  • test_canonical_lemma_minimal_construction()
                  • test_canonical_lemma_full_construction()
                  • test_canonical_lemma_default_language()
                  • test_canonical_lemma_default_script()
                  • test_canonical_lemma_default_metadata_is_independent()
                  • test_canonical_lemma_text_alias()
                  • test_canonical_lemma_id_alias()
                  • test_canonical_lemma_accessors_are_deterministic()
                  • test_canonical_lemma_summary()
                  • test_canonical_lemma_summary_with_defaults()
                  • test_canonical_lemma_display_name()
                  • test_canonical_lemma_string_representation()
                  • test_canonical_lemma_is_frozen()
                  • test_canonical_lemma_equality()
                  • test_canonical_lemma_inequality()
            📄 test_canonical_lexical_record.py
                ⚙️ Functions:
                  • test_canonical_lexical_record_creation()
                  • test_canonical_lexical_record_defaults()
                  • test_summary()
                  • test_string_representation()
                  • test_immutability()
            📄 test_canonical_lexicon.py
                ⚙️ Functions:
                  • test_canonical_lexicon_minimal_construction()
                  • test_canonical_lexicon_full_construction()
                  • test_empty_lexicon_entry_count()
                  • test_empty_lexicon_sense_count()
                  • test_empty_lexicon_all_entries()
                  • test_empty_lexicon_all_senses()
                  • test_empty_lexicon_all_contexts()
                  • test_empty_lexicon_all_sources()
                  • make_context()
                  • make_source()
                  • make_sense(sense_id, context, source)
                  • make_entry(headword, senses)
                  • test_lexicon_entry_count()
                  • test_lexicon_contains()
                  • test_lexicon_get_existing_entry()
                  • test_lexicon_get_missing_entry()
                  • test_lexicon_all_entries()
                  • test_lexicon_iteration()
                  • test_lexicon_sense_count()
                  • test_lexicon_all_senses()
                  • test_lexicon_all_contexts_deduplicates_contexts()
                  • test_lexicon_all_contexts_ignores_missing_context()
                  • test_lexicon_all_sources_deduplicates_sources()
                  • test_lexicon_all_sources_ignores_missing_source()
                  • test_lexicon_summary()
                  • test_lexicon_string_representation()
                  • test_canonical_lexicon_is_frozen()
                  • test_canonical_lexicon_equality()
            📄 test_canonical_reference.py
                ⚙️ Functions:
                  • test_reference_creation()
                  • test_reference_location()
                  • test_reference_location_with_missing_fields()
                  • test_reference_summary()
                  • test_reference_string_with_location()
                  • test_reference_string_without_location()
                  • test_reference_immutability()
            📄 test_canonical_source.py
                ⚙️ Functions:
                  • test_source_creation()
                  • test_display_name_prefers_short_name()
                  • test_display_name_falls_back_to_name()
                  • test_is_online()
                  • test_is_online_false()
                  • test_source_type_classification(source_type, attribute)
                  • test_source_type_classification_is_case_insensitive()
                  • test_source_summary()
                  • test_source_string()
                  • test_source_immutability()
            📄 test_raw_lexical_entry.py
                ⚙️ Functions:
                  • test_raw_lexical_entry_creation()
                  • test_raw_lexical_entry_defaults()
                  • test_has_headword()
                  • test_has_headword_false_for_empty_or_whitespace()
                  • test_has_raw_text()
                  • test_has_raw_text_false_for_empty_or_whitespace()
                  • test_summary()
                  • test_string_representation()
                  • test_immutability()
          📂 parsers/
            📄 test_monier_williams_parser.py
                ⚙️ Functions:
                  • test_default_parser_metadata()
                  • test_iter_records_skips_blank_lines(tmp_path)
                  • test_iter_records_strips_whitespace(tmp_path)
                  • test_extract_headword_returns_first_token()
                  • test_extract_headword_handles_single_token()
                  • test_parse_record_creates_raw_lexical_entry()
                  • test_parse_returns_tuple_of_raw_entries(tmp_path)
                  • test_parse_empty_source_returns_empty_tuple(tmp_path)
                  • test_summary_contains_parser_metadata()
                  • test_string_representation()
          📂 pipelines/
            📄 test_abstract_lexical_pipeline.py
                ⚙️ Functions:
                  • test_abstract_pipeline_cannot_be_instantiated()
                  • test_connect_delegates_to_connector()
                  • test_fetch_delegates_to_connector()
                  • test_parse_delegates_to_parser()
                  • test_transform_delegates_to_transformer()
                  • test_validate_returns_records_unchanged()
                  • test_persist_delegates_to_repository()
                  • test_execute_runs_complete_pipeline_in_order()
                  • test_execute_assigns_manifest()
                  • test_report_returns_pipeline_and_manifest()
                  • test_summary_identifies_pipeline_components()
                  • test_string_representation()
                🏗️ Classes:
            ...
            📄 test_monier_williams_pipeline.py
                ⚙️ Functions:
                  • test_default_pipeline_components()
                  • test_validate_returns_records_unchanged()
                  • test_build_manifest_returns_monier_williams_manifest()
                  • test_build_manifest_sets_monier_williams_identity()
                  • test_build_manifest_sets_resource_version()
                  • test_build_manifest_sets_resource_metadata()
                  • test_build_manifest_declares_pipeline_components()
                  • test_build_manifest_handles_empty_collection()
                  • test_build_manifest_returns_frozen_manifest()
                  • test_pipeline_summary()
                  • test_string_representation()
          📂 registries/
            📄 test_lemma_registry.py
                ⚙️ Functions:
                  • make_lemma(lemma, dhatu)
                  • test_registry_starts_empty()
                  • test_register_lemma()
                  • test_register_multiple_lemmas()
                  • test_lookup_registered_lemma()
                  • test_lookup_missing_lemma_returns_none()
                  • test_lookup_by_text()
                  • test_lookup_by_text_missing_returns_none()
                  • test_duplicate_registration_does_not_increase_count()
                  • test_all_returns_tuple()
                  • test_all_is_sorted_by_lemma_text()
                  • test_lemma_ids_are_sorted()
                  • test_contains()
                  • test_iteration()
                  • test_summary()
            ...
            📄 test_lexical_registry.py
                ⚙️ Functions:
                  • make_lexicon(identifier, name, version)
                  • test_registry_starts_empty()
                  • test_register_lexicon()
                  • test_register_multiple_lexicons()
                  • test_lookup_registered_lexicon()
                  • test_lookup_missing_lexicon_returns_none()
                  • test_lookup_by_name()
                  • test_lookup_by_name_missing_returns_none()
                  • test_duplicate_registration_does_not_increase_count()
                  • test_all_returns_tuple()
                  • test_all_is_sorted_by_name()
                  • test_lexicon_ids_are_sorted()
                  • test_contains()
                  • test_iteration()
                  • test_summary()
                  • test_string_representation()
            📄 test_source_registry.py
                ⚙️ Functions:
                  • make_source(source_id, name, short_name, source_type)
                  • test_registry_starts_empty()
                  • test_register_source()
                  • test_register_multiple_sources()
                  • test_lookup_registered_source()
                  • test_lookup_missing_source_returns_none()
                  • test_lookup_by_name()
                  • test_lookup_by_name_missing_returns_none()
                  • test_lookup_by_short_name()
                  • test_lookup_by_short_name_missing_returns_none()
                  • test_duplicate_registration_does_not_increase_count()
                  • test_all_returns_tuple()
                  • test_all_is_sorted_by_display_name()
                  • test_source_ids_are_sorted()
                  • test_contains()
                  • test_iteration()
                  • test_summary()
                  • test_string_representation()
          📂 repositories/
            📄 test_canonical_lexical_repository.py
                ⚙️ Functions:
                  • make_record(headword, source_name, source_version, record_id)
                  • make_repository()
                  • test_repository_can_be_constructed()
                  • test_repository_is_empty_initially()
                  • test_add_inserts_record()
                  • test_add_supports_multiple_records_for_same_headword()
                  • test_add_supports_multiple_headwords()
                  • test_add_all_inserts_all_records()
                  • test_add_all_accepts_general_iterable()
                  • test_contains_returns_true_for_existing_headword()
                  • test_contains_returns_false_for_unknown_headword()
                  • test_get_returns_all_records_for_headword()
                  • test_get_unknown_headword_returns_empty_tuple()
                  • test_headwords_are_sorted()
                  • test_records_returns_flat_collection()
                  • test_headword_count_counts_unique_headwords()
                  • test_record_count_counts_all_records()
                  • test_contains_protocol_delegates_to_contains()
                  • test_len_returns_record_count()
                  • test_iteration_yields_all_records()
                  • test_summary_reports_repository_statistics()
                  • test_string_representation_contains_counts()
                  • test_get_returns_tuple_not_internal_list()
                  • test_records_returns_tuple()
                  • test_headwords_returns_tuple()
          📂 transformers/
            📄 test_monier_williams_transformer.py
                ⚙️ Functions:
                  • test_default_transformer_metadata()
                  • test_transform_creates_canonical_lexical_record()
                  • test_transform_maps_all_supported_fields()
                  • test_transform_strips_headword()
                  • test_transform_strips_raw_text_into_definition()
                  • test_transform_copies_metadata()
          📂 monier_williams/
